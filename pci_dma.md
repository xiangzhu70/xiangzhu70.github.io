...
|	|Good healthy state	|	|0, or few	|	|few, hw quickly follows to take back BD, so it has data buffer for filling the next received pkt	|	|many, hw has many availble BDs and buffers to fill pkts	|	|few, sw quickly responds to intr_rx_pkt_arrived	|
